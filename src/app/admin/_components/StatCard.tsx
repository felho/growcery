...
const StatCard = ({
  ...
  return (
    <Card
      onClick={handleClick}
      className={`stat-card border-border/50 border transition-all duration-300 ease-in-out ${route ? "hover:border-primary/20 group cursor-pointer hover:translate-y-[-2px] hover:shadow-[0_8px_16px_-6px_rgba(0,0,0,0.2)]" : ""}`}
    >
