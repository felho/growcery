...
export const CompetencyGapsReport = ({
  selectedMatrix,
  filteredEmployees,
  ...
  return (
    <div className="p-6">
      <h2 className="mb-4 text-xl font-semibold">
        Competency Gaps ({filteredEmployees.length} people
                    ...
                    {selectedMatrix.levels.map((level) => {
                      ...
                      const gapPercent =
                        data && data.count > 0 && maxWeight > 0
                          ? Math.round(
                              100 - (data.sum / (data.count * maxWeight)) * 100,
                            )
                          : null;
                      const backgroundColor =
                        gapPercent === null
                          ? "#f3f4f6"
                          : `rgba(220, 38, 38, ${gapPercent / 100})`;
